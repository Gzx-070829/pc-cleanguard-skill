...
def build_source_trace(
    ...
    for record_id, group in grouped.items():
        ...
        lines.extend([
            ...
            f"- version_or_time_scope: {record.get('version_or_time_scope')}",
            f"- affected_component: {record.get('affected_component')}",
            f"- installer_or_bundle_artifact: {record.get('installer_or_bundle_artifact')}",
            f"- distribution_channel: {record.get('distribution_channel')}",
